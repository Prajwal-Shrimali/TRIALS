...
class LawyerDashboardWidget extends StatefulWidget {
  ...
  @override
  _LawyerDashboardWidgetState createState() => _LawyerDashboardWidgetState();
}
                    ...
                    children: [
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'hjd9hoz2' /* Below are the details  */,
                            ),
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'aoejztp5' /* Days until next hearing */,
                                              ),
                                              style:
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'kq11nupb' /* Below is an a summary of activ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ).animateOnPageLoad(animationsMap[
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'seznw9nk' /* Generate nessary documents */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ).animateOnPageLoad(animationsMap[
