...
DocumentReference? get currentUserReference =>
    loggedIn ? LawyerDetailTableRecord.collection.doc(currentUser!.uid) : null;

LawyerDetailTableRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : LawyerDetailTableRecord.getDocument(
                  LawyerDetailTableRecord.collection.doc(uid))
              .handleError((_) {}),
    )
