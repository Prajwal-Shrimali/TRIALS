...
import 'home_login_screen_model.dart';
export 'home_login_screen_model.dart';

class HomeLoginScreenWidget extends StatefulWidget {
  const HomeLoginScreenWidget({super.key});

  @override
  _HomeLoginScreenWidgetState createState() => _HomeLoginScreenWidgetState();
}

class _HomeLoginScreenWidgetState extends State<HomeLoginScreenWidget>
    with TickerProviderStateMixin {
  late HomeLoginScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeLoginScreenModel());
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'hk9svi5q' /* Enter  your User ID to continu... */,
                                                      ),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'r34xyqzj' /* Enter  your Prisoner ID to con... */,
                                                      ),
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .labelMedium
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'tpoz65me' /* Enter  your Prisoner ID to con... */,
                                                      ),
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .labelMedium
